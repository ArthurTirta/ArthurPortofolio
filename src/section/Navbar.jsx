...
function Navbar () {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      SetShowBurger(currentScrollY <= lastScrollY || currentScrollY < 10|| isOpen == true)
  ...
  return(
    <>
      <nav ref={navRef} className='fixed z-50 flex flex-col justify-around w-full h-full px-10 uppercase bg-black lg:text-white/60 py-0 md:w-1/2 md:left-1/2 text-white'>
        ...
        <div ref={contactRef} className='font-light'>
          <p className='tracking-wider text-white/50 '> Email </p>
          <p className='text-xl tracking-widest lowercase text-pretty '> arthur.tirtajaya@gmail.com </p>
        </div>
